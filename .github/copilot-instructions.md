...
| Trade Setup | `prompts/trade-setup.md` | Ticker-only entry pipeline: fundamentals lite + TA + candles + chart structures (H&S/double/triangle/flag) + regime + capital-flow review + gates; recommends swing vs position |
