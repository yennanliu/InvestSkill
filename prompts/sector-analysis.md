...
## Sector Valuation Reference

**Sector P/E vs. S&P 500 Historical Premiums/Discounts**:

| Sector | Typical P/E vs. SPX | Notes |
|--------|---------------------|-------|
| Information Technology | +20–40% premium | Growth premium, high margins |
| Healthcare | At-market to +10% | Defensive growth |
| Financials | 20–30% discount | Capital-intensive, cyclical |
| Consumer Discretionary | At-market to +10% | Cyclical, growth-dependent |
| Communication Services | At-market to +15% | Mix of growth/value |
| Industrials | At-market | Cyclical, earnings-sensitive |
| Consumer Staples | At-market to +5% | Defensive, dividend payers |
| Energy | 10–20% discount | Commodity-linked, volatile earnings |
| Utilities | At-market to +5% | Bond-like, interest rate sensitive |
| Real Estate | Valued on P/FFO not P/E | Yield-driven |
| Materials | 10–20% discount | Commodity-linked, global macro |

## Top Holdings Analysis

- Identify sector leaders and laggards
- Analyze top 5-10 stocks per sector
- Evaluate sector concentration risks (single-stock domination like NVDA in tech)
- Find emerging opportunities within sectors
