...
InvestSkill is a collection of **27 structured analysis frameworks** that turn any AI assistant into an institutional-quality investment analyst. There is no runtime — every skill is a prompt that works in Claude Code, Cursor, Gemini CLI, GitHub Copilot, ChatGPT, or any other LLM.
...
| [Skill Reference](https://yennanliu.github.io/InvestSkill/skills.html) | All 27 frameworks, one browsable page each |
...
**Version:** 1.12.0 · **Skills:** 27 · **Platforms:** 7 · **License:** MIT · **Tests:** 294+ passing
