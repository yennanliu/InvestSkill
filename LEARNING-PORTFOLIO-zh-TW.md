...
> **下一步／相關：** 上一課——[解讀市場](learning-market-zh-tw.html)。你已完成整套課程——回到[學習中心](learning-zh-tw.html)複習，再前往[選擇技能](choose-a-skill-zh-tw.html)把所學全部付諸實行。另可參閱[概念](concepts-zh-tw.html)思維模型與[術語表](glossary-zh-tw.html)。
