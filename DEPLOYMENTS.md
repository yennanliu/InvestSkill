...
## v1.12.0 — 2026-09-25 01:45 UTC

| Field         | Value |
|---------------|-------|
| Version       | `1.12.0` |
| Commit        | `9c90b30` |
| Deployed at   | 2026-09-25 01:45 UTC |
| Skills        | 24 |
| Release       | [GitHub Release](https://github.com/yennanliu/InvestSkill/releases/tag/v1.12.0) |
| CI run        | [Actions run](https://github.com/yennanliu/InvestSkill/actions/runs/36083362766) |
...
| Artifact | Purpose |
|----------|---------|
| `invest-skill-marketplace-1.12.0.tar.gz` | Full marketplace package |
| `us-stock-analysis-1.12.0.tar.gz` | Claude Code plugin only |
| `cursor-rules-1.12.0.mdc` | Cursor rules file |
| `gemini-prompts-1.12.0.tar.gz` | Gemini CLI prompts |
