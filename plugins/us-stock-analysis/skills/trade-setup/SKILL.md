---
description: End-to-end trade setup from a ticker — fundamentals lite, fixed TA stack, candlesticks, trend-strength regime, entry gates, and a strategy that recommends SWING vs POSITION (中長線) from the analysis itself
---
